   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> <i class="fa fa-pencil-alt"></i> edit Slideshow</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">កែប្រែព័ត៌មាន​រឿង</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <!-- start row --> 
                    <div class="form-group">
                      <label for="name">បញ្ចូលរឿង</label>
                      <input type="text" class="form-control" id="slide_name" name="slide_name" value="<?= $name ?>">
                    </div>
